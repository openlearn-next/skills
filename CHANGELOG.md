...
### openlearnflow v1.3.2 — 对齐 2025 版《技术与工程课程标准》

- **课标对齐**：由《普通高中通用技术课程标准（2017年版2020年修订）》全面升级至《普通高中技术与工程课程标准（2017年版2025年修订）》（原文封面另署“日常修订版”）。课程自 2025 年由“通用技术”更名为“技术与工程”。
- **学业质量 4 级 → 3 级**：水平 2 为完成必修课程的要求、学业水平考试合格等级参照；水平 3 为完成必修+选择性必修的要求、等级性考试命题主要依据（命题不超过水平 3）。同步更新 `schema.json`、`competency-objective-map.json` 与专家提示词。
- **课程结构重建**：必修《技术与工程设计 1》《技术与工程设计 2》；选择性必修 3 系列 8 模块（学业发展：工程设计与创新 / 电子控制技术与工程 / 机器人技术与工程 / 科技人文融合创新专题；生活应用：现代家政技术 / 服装设计与制作 / 智能家居技术与工程；职业准备：技术与工程职业探索）；选修 6 模块。
- **核心素养内涵按原文重写**：技术意识、工程思维、创新设计、图样表达、物化能力（维度名称不变，逐条补入“工程”内涵：系统分析与比较权衡、成本质量风险意识、风险评估与综合决策等）。
- **课程性质与理念**：明确“通识性课程”定位，以设计学习、操作学习为主要特征，具有实践性、开放性和综合性；课程理念由 6 条调整为 5 条。
- **内容域扩充**：由 3 个扩充为 5 个（技术与工程设计、结构与设计、流程与设计、系统与设计、控制与设计，后四者为必修“技术与工程设计 2”的四个主题）。
- 同步更新 20+ 个 Expert 提示词、专家配置、文档与示例上下文。
